...
1.  **Start Kafka**: `make start` (or `make up` for background).
2.  **Initialize Topics**: `make init`.
3.  **Check Topics**: `make check`.
4.  **Run Application**: Use your IDE to run the `Office` class.
5.  **Clean up**: `make clean-topics`.
